...
namespace 'bbtangcms' do
  namespace 'extra_query' do
    ...
    task :notes_from_level_id, [:level_id] => [:environment] do |t, args|
      args.with_defaults(:level_id => 2)
    ...
    task :model_tagclound, [:model_class_name, :tag_context] => [:environment] do |t, args|
      args.with_defaults(model_class_name: "Knowledge",tag_context: "timelines")
      ...
      if model_class.present?
        ...
        "no model named #{args.model_class_name}"
      end
    end
    ...
    task :run_simply => [:environment] do |t, args|
      ...
      task_list = [ 
        ...
        ["model_tagclound", []],
        ["model_tagclound", ["knowledge","categories"]],
        ["model_tagclound", ["knowledge","tags"]],
        ["notes_from_level_id", []],
      ...
      task_list.each do |task_opt|
        ...
        Rake.application.invoke_task("bbtangcms:extra_query:#{task.to_s}#{opt}")
        #not work
